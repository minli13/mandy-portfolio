      ...
      <div className='text-center text-black dark:text-white z-200'>
        ...
        <nav className='lg:hidden md:hidden flex flex-col fixed top-0 z-100 w-full'>
          <div class="navbar bg-base-100 shadow-sm">
            <div class="flex-none">
              <button class="btn btn-square btn-ghost" onClick={toggleNav}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" class="inline-block h-5 w-5 stroke-current"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path> </svg>
              </button>
            </div>
            <div class="flex-1">
              <a class="btn btn-ghost text-xl">Mandy's Portfolio</a>
            </div>
            <div class="flex-none">
        ...
        <div id="nav-overlay" className="hidden fixed left-0 w-screen h-screen bg-[var(--background)] dark:bg-[var(--dark-background)] text-4xl">
          <div className="overlay-content h-screen flex flex-col content-evenly gap-5 pt-20">
            <a href="#home" className='p-5 hover:bg-[var(--primary)] dark:hover:bg-[var(--dark-primary)] hover:nav-link-shine hover:nav-link'>HOME</a>
            <a href="#about-me" className='p-5 hover:bg-[var(--primary)] dark:hover:bg-[var(--dark-primary)] hover:nav-link-shine hover:nav-link'>ABOUT ME</a>
            <a href="#projects" className='p-5 hover:bg-[var(--primary)] dark:hover:bg-[var(--dark-primary)] hover:nav-link-shine hover:nav-link'>PROJECTS</a>
            <a href="#skills" className='p-5 hover:bg-[var(--primary)] dark:hover:bg-[var(--dark-primary)] hover:nav-link-shine hover:nav-link'>SKILLS</a>
            <a href="#contact" className='p-5 hover:bg-[var(--primary)] dark:hover:bg-[var(--dark-primary)] hover:nav-link-shine hover:nav-link'>CONTACT</a>
          </div>
        </div>
